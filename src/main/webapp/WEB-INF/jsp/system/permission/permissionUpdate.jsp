...
<form class="form-line col-xs-10" style="padding: 25px; text-align: center">
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            <button class="btn btn-danger" type="button" id="submit">点击修改一个权限信息</button>
        </div>
    </div>
</form>
...
<script>
    ...
    $("#submit").click(
            function () {
                ...
                var permissionStatusVal = $("#permission_status").val();
                var reg = /^[a-zA-Z:]+$/;
    ...
    $(function () {
        var statusVal = "${permission.permissionStatus}";
        $("#permission_status").each(function () {
            $("#permission_status").val(statusVal)
        });
    })
</script>
</html>