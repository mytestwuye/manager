...
<div id="createDialog" class="crudDialog" hidden>
    <form>
        ...
        <div class="form-group">
            ...
            <input id="memberRoleName" type="text" class="form-control">
        </div>
...
<script>
        ...
        oTableInit.Init = function () {
            ...
            $('#table').bootstrapTable({
                ...
                columns: [
                    ...
                    {field: 'memberRoleId', title: '角色ID', sortable: true, align: 'center'},
                    {field: 'memberRoleName', title: '角色名字', sortable: true, align: 'center'},
                ],
    ...
    $("#btn_add").click(function () {
        ...
        layer.open({
            type: 2,
            content: '${pageContext.request.contextPath}/member/role/insert.html',
            area: ['320px', '300px'],
            fixed: true,
            maxmin: true
        });
    ...
    $("#btn_delete").click(function () {
        ...
        if (selectedRadio.length === 0) {
            ...
            //询问框
            layer.confirm('您确定要删除【' + selectedRadio[0].memberRoleName + "】这条成员的信息吗?", {
                btn: ['确定', '点错了'] //按钮
            }, function () {
