        ...
        <div style="width: 400px;">
            <div style="float:left;width:100px; margin-left: 13px; height:42px;">
                <img style="width:100px; height:42px; cursor: pointer;" title="点击刷新" id="getcode_num"
                     src="${pageContext.request.contextPath}/Picture/code.html"/>
            </div>
        </div>
        <div id="softkey3"></div>
    </div>
...
<!-- 底部版权 -->
<%--<p id="copyright">上海心灵伙伴览育信息技术有限公司——沪ICP备13015608号-5
...
<script>
    ...
    $("#getcode_num").click(function () {
        $(this).attr("src", '/site/code.html?rand=' + Math.random());
    });
   ...
   /* //指纹验证登录操作
    xlhbjsonp(
            "http://127.0.0.1:7364/?url=http%3A%2F%2Fstu.xl360.com%2Ffinger%2Fverify-finger.html%3FPHPSESSID%3D&method=login", function (success) {
                //发起登录请求
                if (success) {
                    location.href = "http://stu.xl360.com/finger/finger-login.html?PHPSESSID=";
                }
